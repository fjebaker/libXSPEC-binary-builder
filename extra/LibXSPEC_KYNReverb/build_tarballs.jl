...
sources = [
    GitSource(
        "https://github.com/xstarkit/kynreverb",
        "8a47ce589374d17f1fb1e12425e4fa047cacb8f3",
    ),
    DirectorySource("bundled"),
    FileSource(
        "https://owncloud.asu.cas.cz/index.php/s/abuFcygHKEKFiSa/download",
        "426d7356522c625c62ee6dd92fc016a2c805202372c2fb101ec79e016b8da711";
        filename = "KBHlamp80.fits",
    ),
    FileSource(
        "https://owncloud.asu.cas.cz/index.php/s/WP8aLN168MJgcB9/download",
        "fac193835b6f5981bdab8bff45ec09882ddf533060cfb934a8a41874bfaac799";
        filename = "KBHtables80.fits",
    ),
    FileSource(
        "https://heasarc.gsfc.nasa.gov/xanadu/xspec/models/reflion.mod.gz",
        "4f315fe24d6b8e6e2e6f866df4370b7e3087363c50579376c4f7646cffc6e073",
    ),
    FileSource(
        "https://heasarc.gsfc.nasa.gov/xanadu/xspec/models/reflionx.mod.gz",
        "b0368041414f6e5fe734628571680aba07fc4a9afc06f6e293c9ca0101fb19fa",
    ),
]
